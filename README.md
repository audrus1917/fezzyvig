...
При первом открытии создайте пользователя через форму регистрации, указав имя и
фамилию. После входа HH-токены и вакансии будут храниться отдельно для каждого
пользователя. Сессия передаётся в защищённой от JavaScript `HttpOnly` cookie.
